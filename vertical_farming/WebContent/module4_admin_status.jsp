...
<body>
<h1 style="color: black;">HARVESTING EMPLOYEE DETAILS AND STATUS</h1>
<table>
<%
    ...
    try {
        ...
        String qry = "SELECT * FROM module_4_harvesting";
...
%>
    ...
    %>
        <tr style="text-align: center;">
            ...
            %>
                <td>
                    <a href="admin_approval_harvesting_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
                    ...
                    <br><br>
                    <a href="admin_reject_harvesting_mail.jsp?name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>" class="btn btn-danger">Reject</a>
                </td>
            <%
            } else {
            %>
                <td>
                    <a id="accept_<%= rs.getString("email") %>" href="admin_approval_harvesting_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
