                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        <tr>
                            ...
                            <td data-label="No"><%= rs.getString("No") %></td>
                            <td data-label="Fruit/Vegetable"><%= rs.getString("Fruit_Vegetable") %></td>
                            <td data-label="Variety"><%= rs.getString("Variety") %></td>
                            <td data-label="No of Tons Needed"><%= rs.getString("No_of_Tons_Needed") %></td>
                            <td data-label="Time Period (Months)"><%= rs.getString("Time_Period_Months") %></td>
                            <td data-label="Request Date"><%= rs.getString("Request_Date") %></td>
                            <td data-label="Client Notes"><%= rs.getString("Client_Notes") %></td>
                            <td data-label="Requested By"><%= rs.getString("Requested_By") %></td>
                            <td data-label="Request Status"><%= rs.getString("Request_Status") %></td>
                            <td data-label="Delivery Date"><%= rs.getString("Delivery_Date") %></td>
                        </tr>
                        <%
                    }
                } catch (Exception e) {
