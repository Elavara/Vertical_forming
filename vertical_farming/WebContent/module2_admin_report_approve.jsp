...
<head>
    ...
    <style>
        ...
        .back-button:hover, .approve-button:hover {
            background-color: rgba(62, 142, 65, 0.8);
        }
...
<script>
    function approve() {
        ...
        approveButton.disabled = true; // Disable the button after clicking
        approveButton.innerText = "Approved"; // Change button text
        // Optionally, you can add more functionality here (e.g., make an AJAX call to update the database)
    }
