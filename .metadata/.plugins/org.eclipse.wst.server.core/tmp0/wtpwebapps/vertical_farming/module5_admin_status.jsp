...
<body>
<h1 style="color: black;">TESTING EMPLOYEE DETAILS AND STATUS</h1>
<table>
<%
    ...
    try {
        ...
        String qry = "SELECT * FROM module_5_testing";
...
%>
    ...
    %>
        <tr style="text-align: center;">
            ...
            %>
                <td>
                    <a href="admin_approval_testing_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
            ...
            %>
                <td>
                    <a id="accept_<%= rs.getString("email") %>" href="admin_approval_testing_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
