...
<body>
<h1 style="color: black;"> INVENTORY EMPLOYEE DETAILS AND STATUS</h1>
<table>
<%
...
%>
    ...
    %>
        <tr style="text-align: center;">
            ...
            %>
                <td>
                    <a href="admin_approval_proavailability_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
                    ...
                    <br><br>
                    <a href="admin_reject_proavailability_mail.jsp?name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>" class="btn btn-danger">Reject</a>
                </td>
            <%
            } else {
            %>
                <td>
                    <a id="accept_<%= rs.getString("email") %>" href="admin_approval_proavailability_mail.jsp?user_name=<%= rs.getString("name") %>&email=<%= rs.getString("email") %>&password=<%= rs.getString("password") %>" 
